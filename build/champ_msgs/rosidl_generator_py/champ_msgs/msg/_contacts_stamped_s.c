...
bool champ_msgs__msg__contacts_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("champ_msgs.msg._contacts_stamped.ContactsStamped", full_classname_dest, 48) == 0);
  }
  champ_msgs__msg__ContactsStamped * ros_message = _ros_message;
  {  // header
...
PyObject * champ_msgs__msg__contacts_stamped__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("champ_msgs.msg._contacts_stamped");
