...
bool champ_msgs__msg__pid__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("champ_msgs.msg._pid.PID", full_classname_dest, 23) == 0);
  }
  champ_msgs__msg__PID * ros_message = _ros_message;
  {  // p
...
PyObject * champ_msgs__msg__pid__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("champ_msgs.msg._pid");
