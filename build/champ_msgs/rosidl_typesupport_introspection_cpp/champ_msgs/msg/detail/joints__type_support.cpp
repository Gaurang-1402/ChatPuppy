...
{
  new (message_memory) champ_msgs::msg::Joints(_init);
}

void Joints_fini_function(void * message_memory)
{
  auto typed_message = static_cast<champ_msgs::msg::Joints *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Joints_message_member_array[1] = {
  {
    ...
    offsetof(champ_msgs::msg::Joints, position),  // bytes offset in struct
...
{
  return &::champ_msgs::msg::rosidl_typesupport_introspection_cpp::Joints_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, champ_msgs, msg, Joints)() {
  return &::champ_msgs::msg::rosidl_typesupport_introspection_cpp::Joints_message_type_support_handle;
}
