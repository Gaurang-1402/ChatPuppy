...
{
  new (message_memory) champ_msgs::msg::Point(_init);
}

void Point_fini_function(void * message_memory)
{
  auto typed_message = static_cast<champ_msgs::msg::Point *>(message_memory);
  typed_message->~Point();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Point_message_member_array[3] = {
  {
    ...
    offsetof(champ_msgs::msg::Point, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(champ_msgs::msg::Point, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(champ_msgs::msg::Point, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::champ_msgs::msg::rosidl_typesupport_introspection_cpp::Point_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, champ_msgs, msg, Point)() {
  return &::champ_msgs::msg::rosidl_typesupport_introspection_cpp::Point_message_type_support_handle;
}
